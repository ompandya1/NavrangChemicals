...
// src/app/components/edit-company/edit-company.ts
var EditCompany = class _EditCompany {
  fb;
  service;
  route;
  router;
  ...
  onSubmit() {
    if (this.companyForm.invalid)
      return;
    const dto = __spreadValues({}, this.companyForm.value);
    console.log("Submitting Company:", dto);
    this.service.updateCompany(this.companyId, dto).subscribe({
      next: () => {
  ...
  static \u0275fac = function EditCompany_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _EditCompany)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(CompanyService), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EditCompany, selectors: [["app-edit-company"]], decls: 61, vars: 1, consts: [[3, "ngSubmit", "formGroup"], [1, "card-body", "row", 2, "gap", "0"], [1, "form-group", "row"], ["for", "userName", 1, "col-sm-3", "col-form-label"], [1, "fas", "fa-user"], [1, "col-sm-7"], [1, "input-group"], ["type", "text", "id", "userName", "placeholder", "", "formControlName", "companyName", "readonly", "", 1, "form-control"], ["for", "mobileNo", 1, "col-sm-3", "col-form-label"], [1, "fas", "fa-sticky-note"], ["id", "mobileNo", "placeholder", "Enter GSTIN", "formControlName", "gstin", 1, "form-control"], ["for", "email", 1, "col-sm-3", "col-form-label"], [1, "fas", "fa-envelope"], ["placeholder", "Enter Address", "formControlName", "companyAddress", 1, "form-control"], [1, "form-group", "row", "align-items-start"], ["for", "userRoleId", 1, "col-sm-3", "col-form-label"], [1, "fas", "fa-user-tag"], ["id", "userRoleId", "formControlName", "accNo", 1, "form-control", "select2"], ["for", "companyId", 1, "col-sm-3", "col-form-label"], [1, "fas", "fa-building"], ["id", "companyId", "formControlName", "branchName", 1, "form-control", "select2"], [1, "fas", "fa-phone"], ["type", "number", "id", "companyId", "formControlName", "phone", 1, "form-control", "select2"], ["id", "companyId", "formControlName", "ifsc", 1, "form-control", "select2"], [1, "form-group", "row", 2, "visibility", "hidden"], [1, "card-footer", "d-flex", "justify-content-between", "align-items-center"], ["type", "submit", 1, "btn", "btn-info", "mb-0"], [1, "fas", "fa-save"], [1, "btn", "btn-danger", "ms-auto", 3, "click"], [1, "fas", "fa-times"]], template: function EditCompany_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "form", 0);
      \u0275\u0275listener("ngSubmit", function EditCompany_Template_form_ngSubmit_0_listener() {
        return ctx.onSubmit();
      })("ngSubmit", function EditCompany_Template_form_ngSubmit_0_listener() {
        return ctx.onCancel();
      });
      ...
      \u0275\u0275text(19, " Address ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(20, "div", 5)(21, "div", 6)(22, "textarea", 13);
      \u0275\u0275text(23, "          ");
      \u0275\u0275elementEnd()()()();
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(30, "div", 2)(31, "label", 18);
      \u0275\u0275element(32, "i", 19);
      \u0275\u0275text(33, " Branch Name ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(34, "div", 5);
      \u0275\u0275element(35, "input", 20);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(36, "div", 2)(37, "label", 18);
      \u0275\u0275element(38, "i", 21);
      \u0275\u0275text(39, " Phone No ");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(42, "div", 2)(43, "label", 18);
      \u0275\u0275element(44, "i", 19);
      \u0275\u0275text(45, " IFSC ");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(48, "div", 24)(49, "label", 18);
      \u0275\u0275element(50, "i", 19);
      \u0275\u0275text(51, " IFSC ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(52, "div", 5);
      \u0275\u0275element(53, "input", 23);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(54, "div", 25)(55, "button", 26);
      \u0275\u0275element(56, "i", 27);
      \u0275\u0275text(57, " Update Company ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(58, "button", 28);
      \u0275\u0275listener("click", function EditCompany_Template_button_click_58_listener() {
        return ctx.onCancel();
      });
      \u0275\u0275element(59, "i", 29);
      \u0275\u0275text(60, " Cancel ");
