...
// src/app/components/edit-raw-material/edit-raw-material.ts
var EditRawMaterial = class _EditRawMaterial {
  fb;
  service;
  route;
  router;
  ...
  ngOnInit() {
    ...
    if (id) {
      ...
      this.service.getProductByID(id).subscribe((product) => {
        this.rawMaterialForm.patchValue(product);
  ...
  onSubmit() {
    if (this.rawMaterialForm.invalid)
      return;
    const dto = __spreadValues({}, this.rawMaterialForm.value);
    console.log("Submitting Raw Material:", dto);
    this.service.updateProduct(this.rawMaterialId, dto).subscribe({
      next: () => {
  ...
  static \u0275fac = function EditRawMaterial_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _EditRawMaterial)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(RawMaterialService), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EditRawMaterial, selectors: [["app-edit-raw-material"]], decls: 23, vars: 1, consts: [[3, "ngSubmit", "formGroup"], [1, "card-body", "row", 2, "gap", "0"], [1, "form-group", "row"], ["for", "userName", 1, "col-sm-3", "col-form-label"], [1, "fas", "fa-user"], [1, "col-sm-9"], [1, "input-group"], ["type", "text", "id", "userName", "placeholder", "Enter product name", "formControlName", "name", 1, "form-control"], ["for", "mobileNo", 1, "col-sm-3", "col-form-label"], [1, "fas", "fa-phone"], ["type", "number", "id", "mobileNo", "placeholder", "Enter Price", "formControlName", "price", 1, "form-control"], [1, "card-footer", "d-flex", "justify-content-between", "align-items-center"], ["type", "submit", 1, "btn", "btn-info", "mb-0"], [1, "fas", "fa-save"], [1, "btn", "btn-danger", "ms-auto", 3, "click"], [1, "fas", "fa-times"]], template: function EditRawMaterial_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "form", 0);
      \u0275\u0275listener("ngSubmit", function EditRawMaterial_Template_form_ngSubmit_0_listener() {
        return ctx.onSubmit();
      })("ngSubmit", function EditRawMaterial_Template_form_ngSubmit_0_listener() {
        return ctx.onCancel();
      });
      ...
      \u0275\u0275listener("click", function EditRawMaterial_Template_button_click_20_listener() {
        return ctx.onCancel();
      });
      \u0275\u0275element(21, "i", 15);
      \u0275\u0275text(22, " Cancel ");
