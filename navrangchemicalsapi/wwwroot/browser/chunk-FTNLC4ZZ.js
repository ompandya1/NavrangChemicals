...
// src/app/components/replace-expiry/replace-expiry.ts
function ReplaceExpiry_option_14_Template(rf, ctx) {
  if (rf & 1) {
...
var ReplaceExpiry = class _ReplaceExpiry {
  fb;
  http;
  productService;
  expiryService;
  ...
  expiryDate = "";
  constructor(fb, http, productService, expiryService, route, router) {
    this.fb = fb;
    this.http = http;
  ...
  ngOnInit() {
    ...
    if (id) {
      this.Id = id;
      this.expiryService.getProductByID(id).subscribe((party) => {
        this.qcForm.patchValue(party);
      });
    }
  }
  loadProducts() {
  ...
  save() {
    ...
    this.expiryService.updateProduct(this.Id, payload).subscribe({
      next: () => {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReplaceExpiry, selectors: [["app-replace-expiry"]], decls: 53, vars: 4, consts: [[1, "content"], [1, "container-fluid"], [1, "card", "card-info"], [1, "card-header"], [1, "card-title"], [3, "ngSubmit", "formGroup"], [1, "card-body"], [1, "form-group"], [1, "col-form-label"], ["formControlName", "productId", 1, "form-control"], ["value", ""], [3, "value", 4, "ngFor", "ngForOf"], [1, "form-group", "row", "align-items-center", 2, "flex-direction", "row", "align-items", "center"], [1, "col-md-4"], ["type", "date", "formControlName", "preservingDate", 1, "form-control"], [1, "col-md-2"], ["type", "number", "formControlName", "validity", "min", "1", 1, "form-control"], ["type", "text", "disabled", "", 1, "form-control", 3, "value"], ["type", "number", "formControlName", "strength", 1, "form-control"], ["type", "number", "formControlName", "de", 1, "form-control"], ["type", "number", "formControlName", "da", 1, "form-control"], ["type", "number", "formControlName", "db", 1, "form-control"], ["type", "number", "formControlName", "dc", 1, "form-control"], [1, "card-footer"], ["type", "submit", 1, "btn", "btn-info", 3, "disabled"], ["routerLink", "/qc-standard-expiry", 1, "btn", "btn-danger"], [3, "value"]], template: function ReplaceExpiry_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(14, ReplaceExpiry_option_14_Template, 2, 2, "option", 11);
      \u0275\u0275elementEnd()();
