...
// src/app/components/edit-make/edit-make.ts
var EditMake = class _EditMake {
  fb;
  service;
  route;
  router;
  ...
  ngOnInit() {
    ...
    if (id) {
      ...
      this.service.getProductByID(id).subscribe((product) => {
        this.makeForm.patchValue(product);
  ...
  onSubmit() {
    if (this.makeForm.invalid)
      return;
    const dto = __spreadValues({}, this.makeForm.value);
    console.log("Submitting make:", dto);
    this.service.updateProduct(this.makeId, dto).subscribe({
      next: () => {
  ...
  static \u0275fac = function EditMake_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _EditMake)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(MakeService), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EditMake, selectors: [["app-edit-make"]], decls: 16, vars: 1, consts: [[3, "ngSubmit", "formGroup"], [1, "card-body", "row", 2, "gap", "0"], [1, "form-group", "row"], ["for", "userName", 1, "col-sm-3", "col-form-label"], [1, "fas", "fa-user"], [1, "col-sm-9"], [1, "input-group"], ["type", "text", "id", "userName", "placeholder", "Enter product name", "formControlName", "name", 1, "form-control"], [1, "card-footer", "d-flex", "justify-content-between", "align-items-center"], ["type", "submit", 1, "btn", "btn-info", "mb-0"], [1, "fas", "fa-save"], [1, "btn", "btn-danger", "ms-auto", 3, "click"], [1, "fas", "fa-times"]], template: function EditMake_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "form", 0);
      \u0275\u0275listener("ngSubmit", function EditMake_Template_form_ngSubmit_0_listener() {
        return ctx.onSubmit();
      })("ngSubmit", function EditMake_Template_form_ngSubmit_0_listener() {
        return ctx.onCancel();
      });
      ...
      \u0275\u0275element(11, "i", 10);
      \u0275\u0275text(12, " Update Make ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(13, "button", 11);
      \u0275\u0275listener("click", function EditMake_Template_button_click_13_listener() {
        return ctx.onCancel();
      });
      \u0275\u0275element(14, "i", 12);
      \u0275\u0275text(15, " Cancel ");
